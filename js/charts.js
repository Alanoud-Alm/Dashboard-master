...
const myOrderChart = new Chart(ordersChart, {
    type: 'line',
    data: {
...
// Liner Chart for Cities
 //var citiesChart = document.getElementById("myChart");
 

 new Chart(document.getElementById("pie-chart"), {
     type: 'pie',
    data: {
       labels: ["Saudi Arabia", "America", "Japan", "Spain", "France"],
       datasets: [{
